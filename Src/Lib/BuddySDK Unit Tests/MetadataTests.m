...
describe(@"Metadata", ^{
    context(@"When a user is logged in", ^{
        ...
        it(@"Should be able to search metadata", ^{
            ...
            [c searchMetadata:searchMetadata callback:^(id newBuddyObject, NSString *pagingToken, NSError *error) {
            ...
            [c searchMetadata:nil callback:^(id newBuddyObject, NSString *pagingToken, NSError *error) {
